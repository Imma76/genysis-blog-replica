...
class MobileViewNews extends ConsumerStatefulWidget {
  String articleId, editorsId;
  MobileViewNews({Key? key,required  this.articleId, required this.editorsId}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MobileViewNewsState();
}

class _MobileViewNewsState extends ConsumerState<MobileViewNews> {
 @override
  void initState() {
